...
print('current_dir_path = %s'%(current_dir_path))

FLAGS.model_dir = current_dir_path + '/inception'
print('FLAGS = %s'%(FLAGS))
...
def run_inference_on_image(image):
  ...
  with tf.Session() as sess:
    ...
    for node_id in top_k:
      ...
      emit('image_send_res', human_string);
...
def test_message(message):
    ...
    #tf.app.run(main=main, argv=['d:\\node\\node_ai_new\\image1.jpg'] + unparsed)
    run_inference_on_image('d:\\node\\node_ai_new\\image1.jpg')
